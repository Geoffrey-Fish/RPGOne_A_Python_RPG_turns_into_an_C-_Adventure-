...
namespace RPGOne
    ...
    public class Room
        ...
        public static object Locate(int x,int y)
            {
            var rooms = new List<Room> { start_room,foe_room,gem_room,orc_room,rat_room,stor,wallm1m1,wall1m1,wallm10,wallm11,wallm12,wall12,wall03,wall0m2 };
